...
# % of lines that are chicago
392614/sum(LSL$ServicesLead)*100 #57%
```
...
top50_LSL_P <- LSL_ethnicity_filter %>% 
  ...
  #Stats
    ...
    # % of overall LSLs
    sum(top50_LSL_P$potential)/(sum(LSL$ServicesUnknownMaterial)+sum(LSL$ServicesLead))*100 #67%
