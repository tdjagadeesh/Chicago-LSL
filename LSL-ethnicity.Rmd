...
outersect(LSL_municip_final$Place, IL_boundaries$Place)
...
LSL_ethnicity_filter <- LSL_ethnicity %>% 
  select(GEOID, Place, County, FacilityId, TotalServiceConnections, ServicesLead, ServicesUnknownMaterial, potential, perc_lead, perc_potential, total, white, white_perc, black, black_perc, hispanic = total_hispanic, hispanic_perc = total_hispanic_perc) %>% 
