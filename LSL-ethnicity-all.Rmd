...
top50_LSL_K <- LSL_ethnicity_filter %>% 
  ...
  #Stats
    ...
    # LSL per capita 
      # White 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$white) #0.3288655
      # Black 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$black) #0.5615634
      # Latinx 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$latinx) #0.4794823
      # Asian 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$asian) #2.370452
      # Native 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$native) #117.1041
      # PI 
      sum(top50_LSL_K$ServicesLead)/sum(top50_LSL_K$PI) #754.5029
